  ...
  return (
    <>
      ...
      <div className="wrapper">
        ...
        {/* ── ACQUISITION BANNER ── */}
        <div style={{border:"1px solid rgba(0,255,106,0.2)",background:"rgba(0,255,106,0.04)",padding:"14px 20px",marginBottom:"28px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"12px"}}>
          <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
            <span style={{fontSize:"9px",letterSpacing:"0.25em",textTransform:"uppercase",color:"var(--green)",fontFamily:"var(--font-mono)"}}>For Acquisition</span>
            <span style={{width:"1px",height:"12px",background:"var(--border)",display:"inline-block"}}/>
            <span style={{fontSize:"11px",color:"var(--text-dim)",fontFamily:"var(--font-mono)"}}>postquantumize.com is available for acquisition — domain, codebase, analytics and brand included.</span>
          </div>
